...
ch_icshape = loadicSHAPE(ch_icshape_file, human_seq)
np_icshape = loadicSHAPE(np_icshape_file, human_seq)
cy_icshape = loadicSHAPE(cy_icshape_file, human_seq)
ch_vitro_icshape = loadicSHAPE(ch_vitro_icshape_file, human_seq)
np_vitro_icshape = loadicSHAPE(np_vitro_icshape_file, human_seq)
cy_vitro_icshape = loadicSHAPE(cy_vitro_icshape_file, human_seq)
...
motif_m6A_ensembl_all = read_m6A(m6A_file, human_seq)
