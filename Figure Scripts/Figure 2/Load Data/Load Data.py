...
def load_mouse_parser():
    mm10_parseTrans = ParseTransClass(genomeCoorBedFile = "/tmp/mm10.genomeCoor.bed")
...
def load_human_parser():
    hg38_parseTrans = ParseTransClass(genomeCoorBedFile = "/tmp/hg38.genomeCoor.bed")
...
human_normal_gini, human_start_coding_normal_gini, human_5UTR_normal_gini, human_3UTR_normal_gini = load_human_gini(human_normal_shape, hg38_parseTrans, rev_hist=False)
