...
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=
#          human-mouse
input_dir <- '/Share/home/zhangqf8/lipan/DYNAMIC/icSHAPE/10-11/homo/R_input/'
output_dir <- '/Share/home/zhangqf8/lipan/DYNAMIC/icSHAPE/10-11/homo/R_output/'
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
model <- function(inputFile)
{
    ...
    icTable <- read.csv(paste0(input_dir, inputFile),sep="\t",comment.char="#",head=FALSE, col.names=c('hekID', 'hek_1_based', 'mesID', 'mes_1_based', 'base', 'c1f1', 'c1f2', 'c1f3', 'c1f4','c2f1', 'c2f2', 'c2f3', 'c2f4'))
